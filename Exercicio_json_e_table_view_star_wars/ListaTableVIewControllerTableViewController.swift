//
//  ListaTableVIewControllerTableViewController.swift
//  Exercicio_json_e_table_view_star_wars
//
...
class ListaTableVIewControllerTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let urlApi = "https://www.swapi.co/api/people/"
                ...
                if error != nil {
                    ...
                    do{
                        ...
                        for personagem in personagens{
                            ...
                            guard let nome = personagem["name"] as? String else { return }
                            guard let altura = personagem["height"] as? String else { return }
                            objApp.nome = nome
